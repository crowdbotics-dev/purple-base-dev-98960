"""
Django settings for purple_base_dev_98960 project.
...
ROOT_URLCONF = 'purple_base_dev_98960.urls'
...
WSGI_APPLICATION = 'purple_base_dev_98960.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "purple_base_dev_98960 API",
    "DESCRIPTION": "API documentation for purple_base_dev_98960 App",
    "VERSION": "v1",
}
